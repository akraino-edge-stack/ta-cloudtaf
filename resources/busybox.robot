...
Create Manifest
    ...
    RemoteSession.Copy File To Target  resources/${image_file}.tar  /tmp
    ${result} =  RemoteSession.Execute Command In Target  docker load -i /tmp/${image_file}.tar
    Log  ${result}
...
Delete Manifest
    ...
    RemoteSession.Execute Command In Target  kubectl delete -f /tmp/${image_file}.yaml
