...
class execute_command:  # pylint: disable=old-style-class, invalid-name
    def __init__(self):
    ...
    def execute_unix_command(self,
                             ...
                             user={}):  # pylint: disable=dangerous-default-value, too-many-arguments
        """
    ...
    def execute_unix_command_on_remote_as_root(self,
                                               ...
                                               fail_on_non_zero_rc=True,
                                               delay="90s",
                                               skip_prompt_in_command_output=False):  # pylint: disable=dangerous-default-value, invalid-name, too-many-arguments
    ...
    def check_id_rsa_exists(self):
        stdout, err_code = self.execute_unix_command("ls /home/{0}/.ssh/id_rsa".format(self._default_user["username"]),
