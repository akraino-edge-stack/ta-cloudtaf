...
class stack_infos:
    ...
    INVENTORY_PATH = "/opt/nokia/caas_lcm/deploy/inventory"
    ...
    def __init__(self):
        ...
        try:
            ...
            stdin, stdout, stderr = client.exec_command(self.INVENTORY_PATH)
    ...
    def get_node_ip_based_on_caas_profile(self, caas_profile):
        node_ip = {}
