...
def step1_inspect_clusternetworks():
    ...
    logger.info("Deploying invalid ClusterNetwork manifests fetched from helm chart \'clusternetwork-test-error\'. All should fail.")
...
def step2_inspect_tenantconfigs():
    ...
    logger.info("Deploying invalid TenantConfig manifests fetched from helm chart \'tenantconfig-test-error\'. All should fail.")
...
def step3_inspect_tenantnetworks():
    ...
    logger.info("Deploying invalid TenantNetwork manifests fetched from helm chart \'tenantnetwork-test-error\'. All should fail.")
