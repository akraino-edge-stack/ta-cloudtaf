...
def step6_check_step4_deletion_success():
    common_utils.check_kubernetes_object(kube_object=tennet_pod4,
                                         tester_function=common_utils.test_kubernetes_object_not_available,
                                         timeout=60)
    danm_utils.check_danmnet_endpoints_deleted(tennet_pod4, 'tennet_attach_02', tenantnetwork_attach_properties, tennet_pod4['ip_list'])
...
def step12_none_ip_pod_restart_loop():
    common_utils.helm_install(chart_name="default/tenantnetwork-attach-pod10", release_name="tenantnetwork-attach-pod10")
...
def step13_check_invalid_net_attach_and_successful_damnep_ip_release_after_retries():
    tnet1_alloc_before = danm_utils.get_alloc_value('tennet_attach_01', tenantnetwork_attach_properties, "tenantnetwork")
    tnet5_alloc_before = danm_utils.get_alloc_value('tennet_attach_05', tenantnetwork_attach_properties, "tenantnetwork")
    tnet6_alloc_before = danm_utils.get_alloc_value('tennet_attach_06', tenantnetwork_attach_properties, "tenantnetwork")
...
def step14_check_realloc_ips_of_prev_step_with_dynamic_and_none_ip_alloc():
    common_utils.helm_install(chart_name="default/tenantnetwork-attach-pod12", release_name="tenantnetwork-attach-pod12")
    common_utils.helm_install(chart_name="default/tenantnetwork-attach-pod14", release_name="tenantnetwork-attach-pod14")
